          ...
          <div class="col-md-9 col-lg-8 col-xxl-6">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center fw-bold mb-4">Registrar Personal de Barbería</p>
...
<div class="mb-3">
                  ...
                  <button type="submit" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Guardar</button>
