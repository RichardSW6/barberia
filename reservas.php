              ...
              <div class="col-lg-8">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-6 col-xl-4">
                        ...
                        <label class="card border rounded-2 overflow-hidden w-100 servicio-card" for="corte" style="cursor:pointer;">
                          ...
                          <img src="assets/images/servicios/corte.png" alt="Corte de pelo"
                      ...
                      <div class="col-md-6 col-xl-4">
                        ...
                        <label class="card border rounded-2 overflow-hidden w-100 servicio-card" for="barba" style="cursor:pointer;">
                          <div class="p-3 d-flex align-items-center gap-2">
                      ...
                      <!-- Corte + Barba -->
                      <div class="col-md-6 col-xl-4">
                        <input class="form-check-input d-none" type="radio" name="servicio" id="corte_barba" value="corte_barba">
                        <label class="card border rounded-2 overflow-hidden w-100 servicio-card" for="corte_barba" style="cursor:pointer;">
                          <div class="p-3 d-flex align-items-center gap-2">
                          ...
                          <img src="assets/images/servicios/corte_barba.png" alt="Corte y barba"
                               class="w-100" style="height:160px; object-fit:cover;">
                        </label>
                      </div>
                      ...
                      <!-- Afeitado -->
                      <div class="col-md-6 col-xl-4">
                        <input class="form-check-input d-none" type="radio" name="servicio" id="afeitado" value="afeitado">
                        <label class="card border rounded-2 overflow-hidden w-100 servicio-card" for="afeitado" style="cursor:pointer;">
                          <div class="p-3 d-flex align-items-center gap-2">
                          ...
                          <img src="assets/images/servicios/afeitado.png" alt="Afeitado"
                               class="w-100" style="height:160px; object-fit:cover;">
                        </label>
                      </div>
                      ...
                      <!-- Cuidado de barba -->
                      <div class="col-md-6 col-xl-4">
                        <input class="form-check-input d-none" type="radio" name="servicio" id="cuidado_barba" value="cuidado_barba">
                        <label class="card border rounded-2 overflow-hidden w-100 servicio-card" for="cuidado_barba" style="cursor:pointer;">
                          <div class="p-3 d-flex align-items-center gap-2">
                          ...
                          <img src="assets/images/servicios/cuidado_barba.png" alt="Cuidado de barba"
                               class="w-100" style="height:160px; object-fit:cover;">
                        </label>
                      </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      <div class="col-md-6">
                        <label for="nombrecliente" class="form-label fw-semibold">Nombre completo</label>
                        <input type="text" class="form-control" id="nombrecliente" name="nombre" placeholder="Ej. Juan García" required>
                      </div>
                      <div class="col-md-6">
                        <label for="telefono" class="form-label fw-semibold">Teléfono</label>
                        <input type="tel" class="form-control" id="telefono" name="telefono" placeholder="Ej. 664-123-4567">
                      </div>
                      <div class="col-12">
                        <label for="emailcliente" class="form-label fw-semibold">Correo electrónico</label>
                        <input type="email" class="form-control" id="emailcliente" name="email" placeholder="Ej. cliente@correo.com">
                      </div>

                      <div class="col-12">
                        <label class="form-label fw-semibold d-block">Tipo de cliente</label>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="tipo_cliente" id="frecuente" value="frecuente">
                          <label class="form-check-label" for="frecuente">Cliente frecuente</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="tipo_cliente" id="nuevo" value="nuevo" checked>
